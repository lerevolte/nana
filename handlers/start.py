...
def register_handlers(bot):
    ...
    def start_command(message):
        ...
        try:
            ...
            welcome_message = (
                ...
                f"🔄 Каждый день в 00:00 (МСК) получаешь 1 бесплатную генерацию{referral_bonus_message}\n\n"
    ...
    def balance_command(message):
        ...
        balance_message = (
            ...
            f"🔄 Каждый день в 00:00 (МСК) вы получаете 1 бесплатную генерацию\n"
            f"⏰ Текущее время: {moscow_now.strftime('%H:%M')} МСК\n\n"
    ...
    def help_command(message):
        ...
        help_message = (
            ...
            f"<b>Лимиты:</b>\n"
            f"• 1 бесплатная генерация в день\n"
            f"• Формат вывода: PNG\n\n"
